/*
  ...
  - You are about to drop the column `index_atividade_arefa` on the `atividade` table. All the data in the column will be lost.
  - Added the required column `index_atividade_tarefa` to the `atividade` table without a default value. This is not possible if the table is not empty.
