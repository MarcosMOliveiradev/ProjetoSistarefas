...
CREATE TABLE "analises_mensais" (
	...
	"dias_esperados_empresa" integer NOT NULL,
	"dias_esperados_instituicao" integer NOT NULL,
	"dias_cumpridos_empresa" integer NOT NULL,
	"dias_cumpridos_instituicao" integer NOT NULL,
	"atrasos" integer DEFAULT 0 NOT NULL,
	"percentual_empresa" numeric(5, 2) NOT NULL,
	"percentual_intituicao" numeric(5, 2) NOT NULL,
	"selo" "selo" NOT NULL,
...
ALTER TABLE "kanban_colaboradores" ADD CONSTRAINT "kanban_colaboradores_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_grupos" ADD CONSTRAINT "user_grupos_grupo_id_grupos_id_fk" FOREIGN KEY ("grupo_id") REFERENCES "public"."grupos"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
